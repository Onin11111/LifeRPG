// Niño Cenaon - LifeRPG 1.0

import java.util.Random;
import java.util.Scanner;

public class LifeRPGT1 {
    public static void main(String[] args) {
        ...
        while (isAlive) {
            ...
            System.out.println(LIME_GREEN + "[" + (job.equals("Jobless") ? job : job + " (₱" + payRate + " per year)]") + RESET);
                    ...
                    switch (event) {
                        case 0:
                            ...
                            if (workChoice12 == 1) {
                                ...
                                System.out.println("[Health: -" + healthGain + " ] [ Happiness: -" + happinessGain + " ]");
                            } else {
